    ...
    <script src="{{ config('app.url') }}/assets/js/jquery-validate.js"></script>
    <script src="{{ config('app.url') }}/assets/js/jquery.prettyPhoto.js"></script>
    <script src="{{ config('app.url') }}/assets/js/slick.min.js"></script>
    <script src="{{ config('app.url') }}/assets/js/numinate.min.js"></script>
    ...
    <script src="{{ config('app.url') }}/assets/js/price_range_script.js"></script>
