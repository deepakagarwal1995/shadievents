    ...
    <link rel="shortcut icon" href="{{ config('app.url') }}/assets/images/favicon.png" />

    <!-- bootstrap -->
    <link rel="stylesheet" type="text/css" href="{{ config('app.url') }}/assets/css/bootstrap.min.css" />

    <!-- flaticon -->
    <link rel="stylesheet" type="text/css" href="{{ config('app.url') }}/assets/css/flaticon.css" />

    <!-- fontawesome -->
    <link rel="stylesheet" type="text/css" href="{{ config('app.url') }}/assets/css/font-awesome.css" />
