                    ...
                    <div class="row">
                        <div class="col-lg-12" data-aos="fade" data-aos-duration="1000" data-aos-easing="ease-in-out">
                            ...
                            <div class="section-title title-style-center_text pr-75 res-991-pr-0 pl-75 res-991-pl-0">
                                ...
                                <h6>
At Shadi Events, from venue selection to decor design, vendor coordination to guest experience, we handle every aspect of your special day with care and creativity, that's why we are the <a href="https://shadievents.com" style="    color: #ad8400;">best wedding planners in Agra</a>.</h6>
                                <h6>With the <a href="https://shadievents.com" style="    color: #ad8400;">best event management company in Agra</a>, you can rest easy knowing that your wedding is in the hands of event management experts. Because when your big day arrives, nothing less than perfection will do.</h6>
                            </div><!--section title end-->
                        </div>
                    </div><!--row end-->
