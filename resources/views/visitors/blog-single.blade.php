    ...
    <script type="application/ld+json">
{
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "{{ config('app.url') }}/assets/images/gold-logo-sm.png"
    }
  }
 },
</script>
                            ...
                            <div class="ttm-blog-single-content">
                                <div class="ttm-post-entry-header">
                                    <div class="post-meta">
                                        ...
                                        <span class="ttm-meta-line tags-links"><i class="fa fa-calendar"></i>
                                                    ...
                                                    <ul class="social-icons">
                                                        ...
                                                        <li>
                                                            <a class="twitter" target="_blank"
                                                                href="https://twitter.com/intent/tweet?url={{ $cpurl }}&via=ShozaniaShoes"><i
                                                                    class="fa fa-twitter"></i></a>
                                                        </li>
                                                        <li>
                                                            <a class="pinterest" target="_blank"
                                                                href="https://web.whatsapp.com/send?text={{ $cpurl }}"><i
                        ...
                        <aside class="widget widget-recent-post with-title">
                            ...
                            <ul class="widget-post ttm-recent-post-list">
                                @foreach ($featured as $row)
                                    <li>
                                        <a href="blog-single-simple.html"><img
                                                src="{{ Voyager::image(thumbnail($row->image, 'medium')) }}"
                                                alt="{{ $row->title }}"></a>
                                        <div class="post-detail">
                                            <span class="post-date"><i
                                                    class="fa fa-calendar"></i>{{ date('F j, Y', strtotime($row->created_at)) }}</span>
